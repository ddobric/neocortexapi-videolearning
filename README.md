...
If the video file codec is not mp4 then go to the line where NVideo.CreateVideoFromFrames is initiated and change the argument code = ['P', 'I', 'M', '1'] or ['H', '2', '6', '4']
